...
var flag2 = true;       // flag to toggle between procedural textures
...
onload = function init() {
    ...
    compute_patch_points();	// Call this to fill the points array with all vertex coordinates on the Bezier mesh
